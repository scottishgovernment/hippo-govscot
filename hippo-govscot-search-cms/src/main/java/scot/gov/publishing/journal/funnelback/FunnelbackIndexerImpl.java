 ...
 * Connection settings and site-specific values (accountName, positionKey) are read from {@link FunnelbackConfiguration}.
 */
public class FunnelbackIndexerImpl implements FunnelbackIndexer {
    ...
    public FunnelbackIndexerImpl(FunnelbackConfiguration configuration, String filters) {
        ...
        this.positionUrl = funnelbackCollectionUrl(
                configuration.getPositionCollection(),
                configuration.getPositionKey());
