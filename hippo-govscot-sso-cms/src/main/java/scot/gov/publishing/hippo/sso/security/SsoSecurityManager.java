...
import scot.gov.publishing.hippo.sso.SsoConfigurationException;
...
public class SsoSecurityManager extends SecurityManager {
    ...
    private SecurityProvider provider(String name) {
        ...
        try {
            ...
            throw new SsoConfigurationException("Incompatible change to Bloomreach SecurityManager", ex);
        }
    }
